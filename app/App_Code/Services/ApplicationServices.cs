...
using GiaPhuocSME.Services.Rest;
...
namespace GiaPhuocSME.Services
{
    public abstract class ServiceRequestHandler
    {
        ...
        public virtual bool WrapResponse
        {
            get
            {
                return true;
    ...
    public class ApplicationServicesBase
    {
                ...
                if (_defaultSettings == null)
                {
                    ...
                    if (_defaultSettings == null)
                    {
                        ...
                        if (_defaultSettings == null)
                        {
                            ...
                            EnsureJsonProperty(ui, "sidebar.when", "Never");
        ...
        {
            GiaPhuocSME.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            if (AuthorizationIsSupported)
            {
                ...
                try
                {
                    ...
                    if (css == null)
                        css = ConfigurationManager.ConnectionStrings["GiaPhuocSME"];
                ...
                if (Membership.GetUser("admin") == null)
                {
                    ...
                    admin = Membership.CreateUser("admin", "admin123%", "admin@GiaPhuocSME.com", "ASP.NET", "Code OnTime", true, out status);
                    user = Membership.CreateUser("user", "user123%", "user@GiaPhuocSME.com", "ASP.NET", "Code OnTime", true, out status);
